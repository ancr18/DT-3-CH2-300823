...
function getData(data){
    ...
    // 2. hitung data satu persatu
    data.forEach(user => {
        
        // 3. pecah nama menjadi dua bagian dengan parameter nya spasi
        const partName = user.name.split(' ')

        // 4. tentukan bahwa hanya ada 2 nama, untuk memastikan nama depan dan belakang
        if(partName.length == 2){

            // 5. buat variabel destructuring untuk nama 
            const [firstName, lastName] = partName;
