...
function companies(data) {
    ...
    data.forEach(user => {
        ...
        // 4. ambil huruf pertama dari company
        const firstLetter = user.company.charAt(0)

        // 5. jika huruf pertama company adalah L maka masukkan user tersebut kedalam variabel penampung 
        if(firstLetter === 'L'){
            result.push(user);
        }
    })
...
console.log(`Jumlah company yang huruf pertama nya L adalah : ${companies(users).length}`)