...
function companies(data) {
    ...
    data.forEach(user => {
        ...
        // 4. ambil huruf terakhir dari company
        const company = user.company
        const lastLetter = company.charAt(company.length - 1)

        // 5. jika huruf terakhir company adalah E maka masukkan user tersebut kedalam variabel penampung 
        if(lastLetter === 'E'){
            result.push(user);
        }
    })
...
console.log(`Jumlah company yang huruf terakhir nya E adalah : ${companies(users).length}`)