...
function getFriendFruit(data) {
    ...
    data.forEach(user => {
        ...
        // 4. buat variabel grace untuk menampung teman yang bernama grace
        const grace = user.friends.some(friend => friend.name === "Grace")

        // 5. buat variabel fruits untuk menampung buah favorit 
        const friuts = ["apple", "banana"].includes(user.favoriteFruit)

        // 6. buat kondisi jika kedua variabel bernilai true 
        if(grace && friuts){
            result.push(user);
        }
