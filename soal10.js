...
function registered(data) {
    ...
    data.forEach(d => {
        ...
        // 4. jadikan registreted menjadi sebuah integer
        const year = parseInt(d.registered)

        // 5. bandingkan umur dan tahun
        if(d.age < 30 && year > 2018 ){
            result.push(d)
        }
    });
...
console.log(`Jumlah user yang berumur dibawah 30 dan registrasi diatas tahun 2018 adalah : ${registered(users).length}`)