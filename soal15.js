// ubah user yang gender female address nya menjadi laut, dan user yang gender male address nya gunung

// 1. buat function
function getData(data){
    
    // 2. buat pengecekan data dan menghasilkan array baru
    data.map(user => {

        // 3. ganti value addres menjadi laut jika gender nya female
        if(user.gender === 'female'){
            user.address = 'laut'
        }

        // 4. ganti value address menjadi gunung jika gender nya male
